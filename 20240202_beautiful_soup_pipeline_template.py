...
# and if the id attibute exists, then save the id attribute and
...
# Do a data dump and store the data as json.
def write_data(data, file_path):
    with open(file_path, 'w') as f:
        json.dump(data, f)

# The data pipeline is organized in a sequence of steps to manipulate the 
# data. Run fetch_data(), then parse_data(), then transform_data(), and lastly
# write_data().
